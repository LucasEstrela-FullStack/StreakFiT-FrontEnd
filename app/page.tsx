...
export default async function Home() {
  ...
  const hasData = homeData.status === 200;
  const todayWorkoutDay = hasData ? homeData.data.todayWorkoutDay : undefined;
  const workoutStreak = hasData ? homeData.data.workoutStreak : 0;
  const consistencyByDay = hasData ? homeData.data.consistencyByDay : {};
